...
<ul class="nav justify-content-center">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="nonveg.php" style="color:yellow;"><h5>NON-VEG ITEMS</h5></a>
  </li>
  <li class="nav-item">
...
<section class="main-section">
    <h3 class="text-center color">Non-Veg Items</h3>
    <hr>
    <ul class="teamnav">
      <li class="pic" >
      
        <img src="images/momoc.jpg" width="100%" >
        <br>
        <br>

        <h5 class="text-center">Chicken Momo</h5>
        <p class="text-center">Price: Rs.120</p>
      ...
      <li class="pic">
              <img src="images/cburger.jpg" width="100%" >
        <br>
        <br>
      ...
      <li class="pic">
        <img src="images/cfry.jpg"width="100%"  >
        <br>
        <br>

        <h5 class="text-center">Chicken Fry Rice</h5>
        <p class="text-center">Price: Rs.120</p>
        <!-- <p class="card-text">Quantity</p>
        <div class="text-center"> 
           <input type="number" min="1" max="10" steps="1" name="" id="">
      ...
      <li class="pic" >
        <img src="images/chowmeinc.jpg" width="100%">
        <br>
        <br>

        <h5 class="text-center">Chicken Chowmein</h5>
        <p class="text-center">Price: Rs.120</p>
        <!-- <p class="card-text">Quantity</p>
        <div class="text-center"> 
           <input type="number" min="1" max="10" steps="1" name="" id="">
      ...
      <li class="pic">
        <img src="images/buff.jpg" width="100%">
        <br>
        <br>

        <h5 class="text-center">Buff Fry Rice</h5>
      ...
      <li class="pic">
        <img src="images/sausage.jpg" width="100%">
        <br>
        <br>

        <h5 class="text-center">Chicken Sausage</h5>
        <p class="text-center">Price: Rs.70</p>
        <!-- <p class="card-text">Quantity</p>
        <div class="text-center"> 
           <input type="number" min="1" max="10" steps="1" name="" id="">
            </div><br> -->
